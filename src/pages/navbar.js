...
const navbar = () => {
  return (
    <header aria-label="Site Header">
      <div class="mx-auto max-w-screen-xl py-2 px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="md:flex md:items-center md:gap-12">
            <a class="block text-indigo-600 dark:text-indigo-600" href="/">
          ...
          <div class="flex items-center gap-4">
            <div class="sm:flex sm:gap-4">
              <div class="hidden sm:flex">
                <a
                  class="px-5 py-2.5 text-sm font-medium text-gray-500 dark:text-white hover:!text-gray-300"
                  href="/"
                >
                  Register
                </a>
              ...
              <a
                class="rounded-full bg-gradient-to-r hover:bg-gradient-to-l from-indigo-600 to-cyan-600 px-5 py-2.5 text-sm font-medium text-white shadow dark:hover:bg-indigo-500"
                href="/"
              >
                Login
              </a>
